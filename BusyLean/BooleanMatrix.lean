...
* `instCommSemiringTwo`, `instPartialOrderTwo`, `instIsOrderedRingTwo`:
  This is an upgraded version of `Semiring Two`.
* `instSemiringMatrixFinTwo`, `instPartialOrderMatrixFinTwo`, `instIsOrderedRingMatrixFinTwo`:
...
instance instSemiringMatrixFinTwo : Semiring (Matrix (Fin n) (Fin n) Two) := Matrix.semiring

instance instPartialOrderMatrixFinTwo : PartialOrder (Matrix (Fin n) (Fin n) Two) := {
...
instance instIsOrderedRingMatrixFinTwo : IsOrderedRing (Matrix (Fin n) (Fin n) Two) := {
