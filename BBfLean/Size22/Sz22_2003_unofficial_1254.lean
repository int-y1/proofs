...
/-!
# sz22_2003_unofficial #1254: [5/6, 77/2, 52/35, 33/13, 15/11]
...
namespace Sz22_2003_unofficial_1254
...
-- R4 repeated: move f to b and e (when a=0, c=0)
theorem f_to_b_e : ∀ k b d e f, ⟨(0 : ℕ), b, 0, d, e, f + k⟩ [fm]⊢* ⟨(0 : ℕ), b + k, 0, d, e + k, f⟩ := by
...
-- Canonical state n: (0, 0, 0, n+2, 2n²+4n+3, 2n+2)
-- Transition: n → n+1
theorem main_trans (n : ℕ) :
    ⟨(0 : ℕ), (0 : ℕ), 0, n + 2, 2 * n * n + 4 * n + 3, 2 * n + 2⟩ [fm]⊢⁺
    ⟨(0 : ℕ), (0 : ℕ), 0, n + 3, 2 * n * n + 8 * n + 9, 2 * n + 4⟩ := by
  -- Phase 1: f_to_b_e (move f=2n+2 to b and e)
  rw [show 2 * n + 2 = 0 + (2 * n + 2) from by ring]
  apply stepStar_stepPlus_stepPlus (f_to_b_e (2 * n + 2) 0 (n + 2) (2 * n * n + 4 * n + 3) 0)
  rw [show 0 + (2 * n + 2) = 2 * n + 2 from by ring,
      show 2 * n * n + 4 * n + 3 + (2 * n + 2) = 2 * n * n + 6 * n + 5 from by ring]
  -- Phase 2: R5 (e≥1, c=0, f=0)
  ...
  apply stepStar_trans (r3r1r1_chain (n + 1) 1 0 1 (2 * n * n + 6 * n + 4) 0)
  rw [show 0 + 1 + (n + 1) = n + 2 from by ring,
      show 0 + (n + 1) = n + 1 from by ring]
  -- Phase 4: R3 (c=n+2≥1, d=1≥1)
  rw [show n + 2 = (n + 1) + 1 from by ring,
      show (1 : ℕ) = 0 + 1 from by ring]
  apply stepStar_trans (step_stepStar
    (by simp [fm] : (⟨0, 1, (n + 1) + 1, 0 + 1, 2 * n * n + 6 * n + 4, n + 1⟩ : Q) [fm]⊢
      ⟨2, 1, n + 1, 0, 2 * n * n + 6 * n + 4, n + 2⟩))
  -- Phase 5: R1 (a=2, b=1)
  apply stepStar_trans (step_stepStar
    (by simp [fm] : (⟨2, 1, n + 1, 0, 2 * n * n + 6 * n + 4, n + 2⟩ : Q) [fm]⊢
      ⟨1, 0, n + 2, 0, 2 * n * n + 6 * n + 4, n + 2⟩))
  -- Phase 6: R2 (a=1, b=0)
  apply stepStar_trans (step_stepStar
    (by simp [fm] : (⟨1, 0, n + 2, 0, 2 * n * n + 6 * n + 4, n + 2⟩ : Q) [fm]⊢
      ⟨0, 0, n + 2, 1, 2 * n * n + 6 * n + 5, n + 2⟩))
  -- Phase 7: R3,R2,R2 chain (n+2 rounds)
  have phase7 : ⟨(0 : ℕ), (0 : ℕ), n + 2, 1, 2 * n * n + 6 * n + 5, n + 2⟩ [fm]⊢*
      ⟨(0 : ℕ), (0 : ℕ), 0, n + 3, 2 * n * n + 8 * n + 9, 2 * n + 4⟩ := by
    have h := r3r2r2_chain (n + 2) 0 0 (2 * n * n + 6 * n + 5) (n + 2)
    rw [show 0 + (n + 2) + 1 = n + 3 from by ring,
        show 0 + (n + 2) = n + 2 from by ring,
        show 0 + 1 = 1 from by ring,
        show 2 * n * n + 6 * n + 5 + 2 * (n + 2) = 2 * n * n + 8 * n + 9 from by ring,
...
theorem nonhalt : ¬halts fm c₀ := by
  ...
  apply progress_nonhalt_simple (fm := fm) (A := ℕ)
    (fun n ↦ ⟨0, 0, 0, n + 2, 2 * n * n + 4 * n + 3, 2 * n + 2⟩) 0
  intro n; exists n + 1
  show ⟨(0 : ℕ), (0 : ℕ), 0, n + 2, 2 * n * n + 4 * n + 3, 2 * n + 2⟩ [fm]⊢⁺
       ⟨(0 : ℕ), (0 : ℕ), 0, n + 1 + 2, 2 * (n + 1) * (n + 1) + 4 * (n + 1) + 3, 2 * (n + 1) + 2⟩
  have h := main_trans n
  rw [show 2 * n * n + 8 * n + 9 = 2 * (n + 1) * (n + 1) + 4 * (n + 1) + 3 from by ring,
      show 2 * n + 4 = 2 * (n + 1) + 2 from by ring,
      show n + 3 = n + 1 + 2 from by ring] at h
  exact h

end Sz22_2003_unofficial_1254
