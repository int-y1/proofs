...
/-!
# sz22_2003_unofficial #1631: [77/15, 26/3, 9/91, 5/11, 231/2]
...
namespace Sz22_2003_unofficial_1631
...
theorem main_trans_zero (A : ℕ) :
  ...
  -- drain_chain k=1
  step fm; step fm
  have h := drain_chain 1 (A + 1) 0 1 0
  rw [show (0 : ℕ) + 1 = 1 from by ring,
      show A + 1 + 2 * 1 = A + 3 from by ring,
      show 0 + 1 + 1 = 2 from by ring] at h
  exact h
