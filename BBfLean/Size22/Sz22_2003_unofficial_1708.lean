...
/-!
# sz22_2003_unofficial #1708: [77/15, 9/91, 26/3, 5/11, 99/2]
...
namespace Sz22_2003_unofficial_1708
...
theorem main_trans (A E : ℕ) :
  ...
  -- Phase 2: R5 fires: (A+1, 0, E+1, 0, 0, 2E+2) -> (A, 2, E+1, 0, 1, 2E+2)
  have p2 : ⟨A + 1, 0, E + 1, 0, 0, 2 * E + 2⟩ [fm]⊢⁺
      ⟨A, 2, E + 1, 0, 1, 2 * E + 2⟩ := by
    step fm; finish
  -- Phase 3: Combined drain of (E+1) via interleaved R1/R2
  -- (A, 2, E+1, 0, 1, 2E+2) -> (A, E+3, 0, 0, E+2, E+1)
  have p3 : ⟨A, 2, E + 1, 0, 1, 2 * E + 2⟩ [fm]⊢*
    ...
    exact this
  -- Phase 4: R3 × (E+3): drain b, fill a and f
  have p4 : ⟨A, E + 3, 0, 0, E + 2, E + 1⟩ [fm]⊢*
      ⟨A + E + 3, 0, 0, 0, E + 2, 2 * E + 4⟩ := by
