...
/-!
# sz22_2003_unofficial #1680: [77/15, 9/14, 2/3, 5/11, 99/2]
...
namespace Sz22_2003_unofficial_1680
...
theorem main_trans_even (m : ℕ) :
  ...
  have p1 : ⟨2 * m + 1, 0, 2 * m, 0, (0 : ℕ)⟩ [fm]⊢⁺
    ...
    step fm; finish
  have p2 : ⟨2 * m, 2, 2 * m, 0, (1 : ℕ)⟩ [fm]⊢*
      ⟨m, 2, 0, m, 2 * m + 1⟩ := by
    have h := r1r1r2_chain m m 0 0 1
