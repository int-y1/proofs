...
/-!
# sz22_2003_unofficial #1063: [5/3, 132/35, 1/5, 49/2, 1/77, 5/7]
...
namespace Sz22_2003_unofficial_1063
...
private theorem main_trans (d : ℕ) :
  ...
  · show fm ⟨0, 0, 0, (d + 1) + 1, 0⟩ = some ⟨0, 0, 1, d + 1, 0⟩; unfold fm; rfl
  ...
  rw [show 0 + 2 * (2 * (d + 1)) = 3 * (d + 1) + (d + 1) from by ring]
...
theorem nonhalt : ¬halts fm c₀ := by
  ...
  rw [show 3 * d + 1 + 2 = 3 * d + 3 from by ring]
  exact main_trans d

end Sz22_2003_unofficial_1063
