...
The files numbered from `Sz22_2003_unofficial_1.lean` to `Sz22_2003_unofficial_650.lean` were generated by <https://github.com/int-y1/BBFractran/blob/main/other/gen_lean.py>.

645/650 were proven to be non-halting. The rest are:
* #29, #41, #430: Cryptids.
* #43: Doesn't compile. TODO: redo this.
* #85: Opus 4.6 modified `def fm`. TODO: redo this.
