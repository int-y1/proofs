...
/-!
# sz22_halted_692 #14: [9/35, 4/5, 125/21, 7/2, 15/7]
...
private theorem r3r1_chain_gen : ∀ k b d, (⟨0, b + 1, 0, d + 4 * k⟩ : Q) [fm]⊢^{4 * k} ⟨0, b + 1 + 5 * k, 0, d⟩ := by
...
private theorem r3r1_chain_sn : ∀ k d, (⟨0, 3, 0, d + 4 * k⟩ : Q) [fm]⊢^{4 * k} ⟨0, 3 + 5 * k, 0, d⟩ := by
  intro k d; have h := r3r1_chain_gen k 2 d; simp at h
